...
export class RegisterComponent implements OnInit {
  ...
  async onRegister() {
    ...
    if(this.auth.formValidationRegister(this.NewPerson.name,this.NewPerson.lastName,
        this.newUser.email,this.newUser.password,this.cpassword)){
